...
def ks_testing(modelData, histData):
	"""
	Calculate the 2 sample kolmogorov-smironov test for a distribution of historical and modeled data
...
def threshold_frequency(model_data, obs_data, threshold):
	"""
	Calculate the relative frequency of exceeding a threshold between the modeled and observed data. For example, setting a threshold value of 0.01 for precipitation data will return the difference in percentage of days with trace or less precipitation
	"""
