...
def downscale_example(downscaling_target = 'precip', station_id = '725300-94846'):
	...
	for var in input_vars:
		...
		fig, ax, cbar = som.plot_nodes(weights_index=(start_index, end_index), means = input_means[start_index:end_index], stdevs = input_stdevs[start_index:end_index], cmap='bwr')
